...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 04, 2018 at 03:59 PM
...
INSERT INTO `dichvu` (`id`, `tenDV`, `donviDV`, `soluongDV`, `dongiaDV`) VALUES
(1, 'Giặt ủi', 'Bộ', 1, 15000.00),
(2, 'Nước suối', 'Chai', 1, 10000.00),
(3, 'Bia Heineken', 'Lon', 1, 25000.00),
(4, 'Bia Tiger', 'Lon', 1, 20000.00),
(5, 'Bò cụng', 'Lon', 1, 15000.00),
(6, 'Cam ép Twister', 'Lon', 1, 15000.00),
(7, 'Cocacola', 'Lon', 1, 15000.00),
(8, 'Trà Dr Thanh', 'Chai', 1, 15000.00),
(9, 'Nước yến', 'Lon', 1, 15000.00),
(10, 'Sữa chua', 'Hộp', 1, 10000.00),
(11, 'Sữa tươi', 'Lon', 1, 15000.00),
(12, 'Bật lửa', 'Cái', 1, 4000.00),
(13, 'Thuốc Caraven', 'Gói', 1, 18000.00),
(14, 'Rượu', 'Lít', 1, 20000.00),
(15, 'Rượu Vang Ý IL Pumo Negroamaro', '750ml', 1, 260000.00);
...
(6, 'Trần Cao', 'Nam', NULL, '025563258', NULL, '0998564262', 1),
(7, 'Huỳnh Lập', 'Nam', '1980-12-10', '025563988', NULL, '099856456', 1);
...
INSERT INTO `khunggio` (`id`, `tenKG`, `dieukienKG`) VALUES
(1, 'Theo Giờ', '1 giờ - 11 giờ'),
(2, 'Qua đêm', '12 giờ - 23 giờ'),
(3, 'Theo Ngày', '24 giờ trở đi');
...
INSERT INTO `thongtinkhachsan` (`id`, `ten`, `diachi`, `dienthoai`, `email`, `gioithieu`) VALUES
(1, 'Khách sạn 307', '307 Đường Tô Ký, Xã Tân Xuân, Huyện Hóc Môn, Thành Phố Hồ Chí Minh', '0862503521', '307hotel@gmail.com', 'Khách sạn 307 hứa hẹn mang đến quý khách những trãi nghiệm vô cùng tuyệt vời\r\n');
...
INSERT INTO `thuephong` (`id`, `ngaythueTP`, `ngaytraTP`, `tratruocTP`, `idNVTP`, `idKHTP`, `idPHGTP`, `idGPTP`) VALUES
(1, '2018-02-17', '2018-02-17', 0.00, 2, 2, 28, 3);
...
(1, 'admin', 'admin@gmail.com', '$2y$10$HUpQ4an1lNDm/baOdLR3YO0W/Oy7wq5415qr/dDg0FYyhDgxvqJ8C', 'io5NfPA8O8v1Phl5qOb7mNZd3MpGeMoSCWnAzekVkS8ALL7nF61IZsSIgsPP', NULL, NULL, '', 'images/av.jpg', b'1'),
