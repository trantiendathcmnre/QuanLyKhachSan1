                ...
                <div class="container-fluid">
                  ...
                  <div id="title">
                    <div class="row white" >
                      ...
                      <div class="col-md-auto ml-auto">
                        <a class="text-dark" href="#"><img src="{{asset('images/icAd.png')}}" alt=""> Thêm lầu</a>
                      </div>
                    </div>
                  </div>
                  <!--Danh sach tang lau-->
                  ...
                  <div id="title">
                    <div class="row white" >
                      ...
                      <div class="col-md-auto ml-auto"><!--them moi loai phong-->
                          <a class="text-dark" href="#"><img src="{{asset('images/icAd.png')}}" alt=""> Thêm loại phòng</a>
                      </div>
                    </div>
                  </div>
                  <div class="row white" >
                  ...
                  <div class="row borderbt" >
                    ...
                    <div class="col-md-2 align-items-center align-self-center ml-auto">
                      <a href="#" class="text-dark" title="Thêm phòng" style="font-size: 15px; text-decoration: none"><img src="{{asset('images/icAd.png')}}"> Thêm phòng</a><!--Them moi phong-->
                    </div>
                  </div>
